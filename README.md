...
> There is a chance [YavaScript ](https://github.com/suchipi/yavascript) will be supported (or [zig-quickjs-ng](https://github.com/mitchellh/zig-quickjs-ng)), as it likely capable of doing most of the tasks regarding provisioning. It is less than 4MB versus Bun 100MB because it does not provide nodejs layer. Read more about it in [doc/bun.light.md](doc/bun.light.md).
