...
Most users encounter this package when following installation guides for third-party software (like **Docker**, **Ansible**, or **Node.js**). If you try to run `add-apt-repository` and get a "command not found" error, you 
...
must install this package first using:
